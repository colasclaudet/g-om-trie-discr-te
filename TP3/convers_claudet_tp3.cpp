...
std::vector<ContourPol> approximer_contour_c8(ContourF8 * cfc, cv::Mat img)
{
	...
	vect_contour_pol = homcon(vect_contour_pol, vect_contour_pol.at(0),0,vect_contour_pol.at(index),index,dmax,seuil);
	...
	if(vect_contour_pol.size()<4 || vect_contour_pol.size()>300){return vect_contour_pol;}
	...
	{
		std::cout<<"_______________modif img : ________________"<<std::endl;
